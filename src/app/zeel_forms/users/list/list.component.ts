...
export class ListUsersComponent {
    ...
    displayedColumns: string[] = ['id', 'display_name', 'mobileno', 'status', 'edit'];
    ...
    constructor(private HttpService: HttpService,
        ...
        this.HttpService.postData('masters/listUsers', {}).pipe(takeUntil(this._unsubscribeAll)).subscribe((res: any) => {
