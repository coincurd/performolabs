...
export class ListProjectConfigComponent {

    private _unsubscribeAll: Subject<any>;
    groupData: any[] = [];

    displayedColumns: string[] = ['id', 'company', 'total_req_pow', 'edit'];
    ...
    constructor(  private HttpService : HttpService) {
        ...
        this.HttpService.postData('masters/listConfigMaster',{}).pipe(takeUntil(this._unsubscribeAll)).subscribe((res: any) => {
