...
import { SamInputComponent } from  './zeel_forms/sam_input/sam.component';

import { AddUsersComponent } from  './zeel_forms/users/add/add.component';
import { ListUsersComponent } from  './zeel_forms/users/list/list.component';
import { UsersInputComponent } from  './zeel_forms/users/users.component';
...
export const routes: Routes = [
    ...
    {path: 'zeel_dashboard', component: ZeelDashboardComponent, canActivate : [ AuthGuard ]  },
    {path: 'dates_list', component: datesListComponent, canActivate : [ AuthGuard ]},
    {
        path: 'sam',
        component: SamInputComponent,
        canActivate : [ AuthGuard ],
        children: [
            {path: 'list', component: ListSamComponent},
            {path: '', component: AddSamComponent},
        ]
    },
    {
        path: 'users',
        component: UsersInputComponent,
        canActivate : [ AuthGuard ],
        children: [
